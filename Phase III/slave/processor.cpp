...
processor::executor(vector<Instruction> instructionss) // constructor
{
...
{
    fitcher parse_me; // parser to parse each instruction
...
void processor::addf(int in1, int in2, int out1)
{
...
void processor::negf(int in1, int out1)
{
...
void processor::mulf(int in1, int in2, int out1)
{
    int temp1 = dataMem[in1];
    int temp2 = dataMem[in2];
    dataMem[out1] = dataMem[in1] * dataMem[in2];
...
void processor::jpaf(int a1, int &index)
{
    if (a1 < 0 || a1 > 1023)
    {
...
void processor::jpof(int in1, int a1, int &index)
{
    if (a1 < 0 || a1 > 1023)
    {
        cout << "Instruction memory index is out of range!" << endl;
...
void processor::asif(int in1, int out1)
{
    dataMem[out1] = in1;
    printf("The SIM just assigned the value of memory location %d to %d \n", out1, in1);
}

void processor::loef(int in1, int in2, int out1)
{
